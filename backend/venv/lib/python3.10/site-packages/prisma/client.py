...
SCHEMA_PATH = Path('/Users/kachevn1k/Projects/cian_for_tr/.claude/worktrees/kind-chebyshev/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/kachevn1k/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    agency: 'actions.AgencyActions[models.Agency]'
    city: 'actions.CityActions[models.City]'
    district: 'actions.DistrictActions[models.District]'
    neighborhood: 'actions.NeighborhoodActions[models.Neighborhood]'
    listing: 'actions.ListingActions[models.Listing]'
    ...
    def __init__(
        ...
        *,
        ...
        self.agency = actions.AgencyActions[models.Agency](self, models.Agency)
        ...
        self.neighborhood = actions.NeighborhoodActions[models.Neighborhood](self, models.Neighborhood)
        self.listing = actions.ListingActions[models.Listing](self, models.Listing)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/kachevn1k/Projects/cian_for_tr/.claude/worktrees/kind-chebyshev/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    agency: 'AgencyBatchActions'
    city: 'CityBatchActions'
    district: 'DistrictBatchActions'
    neighborhood: 'NeighborhoodBatchActions'
    listing: 'ListingBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.agency = AgencyBatchActions(self)
        self.city = CityBatchActions(self)
        self.district = DistrictBatchActions(self)
        self.neighborhood = NeighborhoodBatchActions(self)
        self.listing = ListingBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class NeighborhoodBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
